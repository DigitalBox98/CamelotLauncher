...
namespace CamelotLauncher.Views
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            folderBtn = this.Find<Button>("FolderBtn");
            ...
            daocLocation = this.Find<TextBlock>("DaocLocation");
        ...
        public void Connect_onClick(object sender, RoutedEventArgs args)
        {
            ...
            gameDll = realLocation + fileSeparator + "game.dll";
            ...
            if (wine.IsChecked == true)
            {
                proc1.Arguments = @"cmd.exe /C ""cd /d " + @location + @" && connect.exe"" game.dll " + server + " " + login + " " + pass;
            }
            else
            {
                proc1.Arguments = @"""" + @location + @fileSeparator + "game.dll" + @""" "+ server + " " + login + " " + pass;
            }
        ...
        public async void Folder_onClick(object sender, RoutedEventArgs args)
        {
